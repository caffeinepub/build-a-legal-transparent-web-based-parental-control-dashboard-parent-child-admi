      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            <span>© {currentYear} FamilyGuard</span>
            <span>•</span>
            <button
              onClick={onShowPolicies}
              className="hover:text-amber-600 dark:hover:text-amber-400 underline"
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="font-semibold hover:text-amber-600 dark:hover:text-amber-400 flex items-center gap-1"
            >
              caffeine.ai
            </a>
          </div>
